...
- Timeline V2 is query-time derived from existing feature tables. Do not add a `timeline_events` table unless profiling shows the adapter aggregation needs a rebuildable cache.
