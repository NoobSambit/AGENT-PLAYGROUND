...
function mapAgentRow(row: AgentRow): AgentRecord {
  return {
    ...
    activeDreamImpression: row.activeDreamImpression || undefined,
...
function toAgentInsert(agent: AgentRecord): typeof agents.$inferInsert {
  return {
    ...
    activeDreamImpression: agent.activeDreamImpression ?? null,
...
function toAgentUpdate(updates: Partial<AgentRecord>): Partial<typeof agents.$inferInsert> {
  return compact({
    ...
    activeDreamImpression: 'activeDreamImpression' in updates ? updates.activeDreamImpression ?? null : undefined,
