...
export class AchievementService {
   ...
   */
  getAchievementProgress(achievement: Achievement, stats: AgentStats, progress?: AgentProgress): number {
    const safeProgress = this.ensureProgress(progress)
    const metricValue = this.getMetricValue(achievement.requirement.metric, stats, safeProgress)
  ...
  getLockedAchievements(
    ...
    return ACHIEVEMENTS
      ...
      .map(a => ({
        ...a,
        progress: this.getAchievementProgress(a, stats, progress)
      }))
  ...
  private ensureProgress(progress?: AgentProgress): AgentProgress {
